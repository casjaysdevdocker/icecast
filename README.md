...
```shell
dockerHome="/srv/$USER/docker/casjaysdevdocker/icecast/icecast/latest/rootfs"
mkdir -p "/srv/$USER/docker/icecast/rootfs"
...
services:
  ProjectName:
    ...
    environment:
      ...
      - HOSTNAME=icecast
    volumes:
      - "/srv/$USER/docker/casjaysdevdocker/icecast/icecast/latest/rootfs/data:/data:z"
      - "/srv/$USER/docker/casjaysdevdocker/icecast/icecast/latest/rootfs/config:/config:z"
    ports:
      - 80:80
    restart: always
```
